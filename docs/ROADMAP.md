...
**Status (2026-07-28): all six rungs are exited.** Rungs 1–4 closed at their per-rung gates (histories in [TASKS.md](TASKS.md) and the [ADR index](adr/)); Rungs 5 and 6 were blessed together at the **combined feature-complete review** of v0.1.0 ([REVIEW-v0.1.0.md](REVIEW-v0.1.0.md), all parts passed — Rung-6's blessing is [ADR-0015](adr/0015-rung6-temporal-architecture.md) → Accepted). The open goal is the North Star itself: **measured drop-in parity**, with the scorecard's honest remainder (capacity/budget defers and [LIMITATIONS.md](../LIMITATIONS.md)) as the distance left. Versioning is deliberately zero-based (owner, 2026-07-28): mettle stays 0.x — minor bumps for milestones, patches for fixes — and reaching drop-in is announced by the scorecard, not a 1.0.0.
